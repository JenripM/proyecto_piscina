...
<div class="bgded overlay padtop" style="background-image:url('{{asset('plantillap/images/demo/backgrounds/01.jpg')}}');"> 
  <!-- ################################################################################################ -->
  <!-- ################################################################################################ -->
  <!-- ################################################################################################ -->
  <header id="header" class="hoc clear">
    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        ...
        @auth
           <li><a href="{{ url('/dashboard') }}">PANEL DE USUARIO</a></li>
        @else
...
<!-- JAVASCRIPTS -->
<script src="{{asset('plantillap/scripts/jquery.min.js')}}"></script>
<script src="{{asset('plantillap/scripts/jquery.backtotop.js')}}"></script>
<script src="{{asset('plantillap/scripts/jquery.mobilemenu.js')}}"></script>
</body>
</html>